// Teardrop Attack Implementation in C
...
// Function to create an IP packet with overlapping fragments
void create_fragmented_packet(char *packet, int packet_size) {
    // Packet structure: IP header + data
    // For simplicity, we'll just create a basic fragmented packet
    // In a real attack, you would need to handle IP headers properly
}
...
void *attack_thread(void *arg) {
    ...
    create_fragmented_packet(packet, PACKET_SIZE);
